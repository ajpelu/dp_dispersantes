...
pdf(file=paste(di,'/figures/plot_family.pdf',sep=""), width = 12, height = 8)
f
dev.off()
...
pdf(file=paste(di,'/figures/plot_genus.pdf',sep=""), width = 12, height = 8)
g
dev.off()
   
## Hay mucho hueco entre los géneros y las barras?  Las barras salen unidas
...
pdf(file=paste(di,'/figures/plot_families_passeri.pdf',sep=""), width = 10, height = 8)
pa
dev.off()
```
...
pdf(file=paste(di,'/figures/plot_genus_passeri.pdf',sep=""), width = 10, height = 8)
ge
dev.off()
```
