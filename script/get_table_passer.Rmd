...
#3. Rename columns
names(data) <- c("Scientific name", "Spanish Red List", "Birds Directive", "Bern", "Bonn", "Spanish Name", "English Name")

write.table(data, file = paste(di,"/data/taxa_passer_modif.csv", sep=""), row.names=FALSE, quote= FALSE, sep = ";", fileEncoding='UTF-8')
```
