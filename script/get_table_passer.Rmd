...
4. Add the column "IUCN Red List Category (Europe)". For this column we use information from " Appendix 1 of 'Red List status of all European bird species and their protection status under international legislation, conventions and agreements'
...
#Rename columns
names(data) <- c("Nombre Cient?fico", " ")
```
